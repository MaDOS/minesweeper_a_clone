...
namespace minesweeper_a_clone_client
{
    public class checkBox
    {
        ...
        public checkBox(Texture2D initTexture, GraphicsDevice graphics)
        {
            this.texture = initTexture;
            this.size = new Vector2(graphics.Viewport.Width / 8, graphics.Viewport.Height / 30);
        }

        public checkBox(Texture2D initTexture, GraphicsDevice graphics, Vector2 position)//Overload 1 to define position directly
        {
            this.texture = initTexture;
            this.size = new Vector2(graphics.Viewport.Width / 8, graphics.Viewport.Height / 30);
